...
[CmdletBinding(SupportsShouldProcess = $False, ConfirmImpact = "None", DefaultParameterSetName = "HTML") ]
...
Param(
	...
	[string]$CompanyName="CreditOne Bank",
	...
	[string]$SmtpServer="mailgateway.Contoso.corp",
	...
	[parameter(ParameterSetName="SMTP",Mandatory=$True)] 
	[string]$From="DNS_Servers@creditone.com",

	[parameter(ParameterSetName="SMTP",Mandatory=$True)] 
	[string]$To="john.battista@creditone.com",
